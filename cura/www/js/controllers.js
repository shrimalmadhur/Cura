		...
		$scope.init=function(){
			$.ajax({
				...
				success: function(response){
					$("#StressEvents").html("<h2><b>Stress Events:     </b>"+response[0]["number_stress_events"]+"</h2>");
					$("#RelaxedEvents").html("<h2><b>Relaxed Events:   </b>"+response[0]["number_relax_events"]+"</h2>");
					$("#SteadyEvents").html("<h2><b>Steady Events:   </b>"+response[0]["number_steady_events"]+"</h2>");
					$("#FinalScore").html("<h2><b>Final Score:   </b>"+response[0]["stress_score"]+"</h2>");
				},
				error:function(){
					alert("Hi.");
				}
